...
def test_meta_dispatch():
    ...
    expected = {
        ...
        '%%_PATCH_%_APPROVALS_%_ADJUSTABLE_%_VERTICAL_%_SPACE_%%': '2.5em',
...
def test_meta_dispatch_explicit():
    ...
    expected = {
        ...
        '%%_PATCH_%_APPROVALS_%_ADJUSTABLE_%_VERTICAL_%_SPACE_%%': mapper['approvals_adjustable_vertical_space'],
