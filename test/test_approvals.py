...
def test_inject_eastwards_many():
    ...
    expected = [
        ...
        r'\hline',
        r'\ \mbox{\textbf{Date}} \mbox{\textbf{\ \ \ \ \ \ }} \mbox{\textbf{\ Signature}}%',
        r' & \begin{Form}\hspace*{-2mm}\fbox{\digitalsignaturefield{30.55mm}{6.05mm}{name1}}\end{Form}',
        r' & \begin{Form}\hspace*{-2mm}\fbox{\digitalsignaturefield{30.55mm}{6.05mm}{name2}}\end{Form}',
        r' & \begin{Form}\hspace*{-2mm}\fbox{\digitalsignaturefield{30.55mm}{6.05mm}{name3}}\end{Form}',
        r' & \begin{Form}\hspace*{-2mm}\fbox{\digitalsignaturefield{30.55mm}{6.05mm}{name4}}\end{Form}',
        r' \\[0.5ex]',
        r'\hline',
        '',
        r'\end{longtable}',
        ...
        r'\hline',
        r'\ \mbox{\textbf{Date}} \mbox{\textbf{\ \ \ \ \ \ }} \mbox{\textbf{\ Signature}}%',
        r' & \begin{Form}\hspace*{-2mm}\fbox{\digitalsignaturefield{30.55mm}{6.05mm}{name5}}\end{Form}',
        r' \\[0.5ex]',
        r'\hline',
        '',
        r'\end{longtable}',
