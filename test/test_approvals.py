...
def test_inject_eastwards_many():
    ...
    expected = [
        ...
        r'\hline',
        r'\ \mbox{\textbf{\theApprovalsRoleLabel}}%',
        r' & \centering\arraybackslash rolen1',
        r' & \centering\arraybackslash rolen2',
        r' & \centering\arraybackslash rolen3',
        r' & \centering\arraybackslash rolen4',
        r' \\[0.5ex]',
        r'\hline',
        r'\ \mbox{\textbf{\theApprovalsNameLabel}}%',
        ...
        r'\hline',
        r'\ \mbox{\textbf{\theApprovalsRoleLabel}}%',
        r' & \centering\arraybackslash rolen5',
        r' \\[0.5ex]',
        r'\hline',
        r'\ \mbox{\textbf{\theApprovalsNameLabel}}%',
